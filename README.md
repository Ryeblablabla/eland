...
> “第 183 号文明毁灭于三日凌空。该文明曾进化至现代文明（含信息能力）。漫长岁月之后，生命与文明将再次启动……”

![ELAND：三颗太阳之下，河畔文明在劳作与灾变之间生长](docs/assets/eland-readme-promo-v1.png)

ELAND 是一款开源的 Agent 文明模拟游戏，也是一只会自行生长的赛博鱼缸。它的灵感来自《三体》中的三体游戏，以及 AIvilization 等智能体实验。
...
这里没有预先写好的文明剧本。每个 Agent 依据自己感知到的环境、个人记忆、现实需要、社会关系与已有知识作出选择。模型形成目标、规划行动，也可以提出已有动作目录之外的做法。世界 Plan 将想法翻译成实际尝试，领域内核提交物资、位置、身体和社会后果，人物再根据结果继续或修正计划。
