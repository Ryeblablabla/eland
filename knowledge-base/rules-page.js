  ...
  <div class="rules-shell">
      ...
      <div class="rule-branch-grid">
        ...
        <details class="rule-branch" data-tone="agent" open>
          ...
          <ul>
            ...
            <li><strong>年龄与能力</strong><span>未满 1 岁依赖亲代；1–11 岁可自主选择跟随、取水、拾取、学习和简单劳动；12–15 岁可生产及协作既有项目；16 岁起才有完整规划能力。</span></li>
            <li><strong>身体与人格</strong><span>身体储备、状态限制、HEXACO 六维、控制 / 地位敏感度、亲缘认识和共同体职责；经历只能通过带来源证据缓慢改变人格。</span></li>
            <li><strong>当前意图</strong><span>一个执行焦点；其他压力不会同时变成并行动作。</span></li>
          </ul>
          <code>domain/person.ts · domain/memory.ts · application/action-options.ts</code>
        </details>
        ...
        <details class="rule-branch" data-tone="agent" open>
          ...
          <ul>
            ...
            <li><strong>承诺</strong><span>提议必须回应；生效协议要通过后续行动履约。生殖接受只授权一次尝试，任一方可在尝试前撤回；最终动作会重验 60 / 60，关系跌破后旧同意不能继续执行，冲突扣减后仍达门槛则不额外禁止。</span></li>
            <li><strong>传播</strong><span>观察到的成功可复查、教导、模仿或写入实体记录。</span></li>
            <li><strong>制度</strong><span>多人项目、重复角色、授权与分配闭环改变未来行为时才成立。</span></li>
          </ul>
          <code>application/social-options.ts · domain/governance.ts</code>
        </details>
    ...
    <section class="rules-section" id="decisionTree" aria-labelledby="decisionTreeTitle">
      <div class="section-heading">
        ...
        <p>决定不是一次性抽签。稳定意图默认延续；只有紧急反射、必须回应、履约、真实的新机会或客观停滞能改变焦点。玩家可在模型设置页（M）分别切换当前文明的本地 / 模型演进与本地 / 模型总结；模型演进只可重选少量本地合法候选，模型总结只压缩已发生事实，任一路径失败都保留规则结果。</p>
      </div>
      ...
      <div class="decision-map" aria-label="人物详细决策树">
                  ...
                  <li><span class="edge-label">planning tick × 15</span>
                    ...
                    <ol>
                      ...
                      <li><span class="edge-label edge-yes">是</span>
                        <article class="logic-node" data-kind="condition"><span>G2</span><h4>处于脱水休眠？</h4><p><code>dehydrated-hibernation</code> 禁止普通行动。重新水化需近身水源与身体危机、预言失效 / 已应验或有来源的预言质疑；同一待验证计划不能被无新证据反复唤醒。</p></article>
                        <ol>
                          ...
                          <li><span class="edge-label edge-no">否</span>
                            <article class="logic-node" data-kind="condition"><span>G3</span><h4>本人或依赖者谁更紧急？</h4><ul><li>本人：水分 &lt;58、有食物且营养 &lt;52、无食物且营养 &lt;34，或已有冷热压力。</li><li>依赖者：同位置、12 岁以下，比较缺水、缺食、健康与冷热压力。</li><li>两边先换算到同一紧急度尺度；孩子危机更重时优先照护，而非固定本人在前。</li><li>未满 1 岁的清醒婴儿不会独自迁移，同处亲代移动时会被携带；脱水休眠者始终留在原位。</li></ul></article>
                            <ol>
                              ...
                              <li><span class="edge-label edge-no">没有</span>
                                <article class="logic-node" data-kind="condition"><span>G4</span><h4>年轻依赖者需要紧急照护？</h4><ul><li>同位置、12 岁以下，优先最缺水 / 缺食者。</li><li>水分或营养 &lt;40；冷热压力；或严重乱纪元下满足安全条件的脱水保护。</li></ul></article>
                                <ol>
                                  <li><span class="edge-label edge-yes">孩子更急</span><article class="logic-node compact-node" data-kind="action"><span>CARE</span><h4>创建照护子中断</h4><p>移动、转移食物、寻找水 / 住所或帮助脱水；不把这段时间算作父项目停滞。</p></article></li>
                                  <li><span class="edge-label edge-no">不需要</span>
                                    <article class="logic-node" data-kind="condition"><span>G4-B</span><h4>年龄允许进入哪层规划？</h4><ul><li>未满 1 岁：留在亲代身边或原地等待照料，清醒时由同处亲代携带。</li><li>1–11 岁：不再自动随亲代移动，可自主选择跟随，并限于取水、拾取、学习、采收、拾柴等简单劳动。</li><li>12–15 岁：可参与生产与既有项目，不能发起重大项目或繁衍。</li><li>16 岁以上：进入完整规划。</li></ul></article>
                                    <article class="logic-node" data-kind="condition"><span>G5</span><h4>应继续留在住所？</h4><p>本人或依赖者有 ≥1 级冷热压力，脚下是真实遮蔽，照护者水分 ≥45、营养 ≥40，且没有更具体的住所改造项目。</p></article>
                                    <ol>
        ...
        <section class="decision-phase" aria-labelledby="intentTreeTitle">
          ...
          <div class="decision-tree-scroll wide-tree-scroll">
            <ol class="logic-tree">
              <li>
                <article class="logic-node" data-kind="condition"><span>P1</span><h4>本刻度需要重新审视吗？</h4><ul><li>没有当前意图，或有待回应 / 待履约协议；未执行的生殖协议每个刻度都允许继续或撤回。</li><li>tick 1：健康 &lt;35，水分 / 营养 &lt;28，或冷热 / 伤病 ≥2 级。</li><li>状态目标已过期；或距上次进展 ≥2 个月且目标未满足。</li><li>另行探测：月初生活复核、匹配项目缺口的记录、技术示范请求、需回应的真实对话。</li><li>完整的可选重规划每人每月最多一次；15 个行动刻度仍全部执行，紧急生存、履约、技术示范和新收到的真实对话可在后续刻度继续即时打断。</li></ul></article>
                <ol>
                  ...
                  <li><span class="edge-label edge-yes">是</span>
                    <article class="logic-node" data-kind="process"><span>P2</span><h4>在只读快照中编译候选</h4><p>输入只有可见格 / 人 / 动物 / 掉落物、本人记忆与知识、项目、协议、权限和当前意图。预览搜索路线和物流步骤不会打开真实 campaign 或改写项目；年龄门禁在每次编译时执行。若存在必须回应，候选集会收窄为这些回应。</p></article>
                    <ol>
                      <li><span class="edge-label">候选已排序</span>
                        <article class="logic-node score-node" data-kind="process"><span>FACTOR FOREST</span><h4>八棵可解释因果树投票</h4><ul><li><b>need</b>：身体、物资与住所缺口；<b>care</b>：眼前他人的危险与照护关系。</li><li><b>commitment</b>：既有项目连续性与项目压力；<b>learning</b>：观察、记录和技术缺口。</li><li><b>relationship</b>：有来源的信任、羁绊、恐惧和社会接近；<b>consent</b>：具体协议的接受 / 拒绝 / 撤回、已学得风险、产后恢复和已有子女责任。</li><li><b>feasibility</b>：来源、耗时和风险；<b>harm</b>：伤害是否有足够生存压力；每棵树保留理由与来源事实。</li><li><b>HEXACO 调节</b>：H 调节占取与强制，E 调节照护与避险，X 调节主动社交，A 调节合作与冲突，C 调节项目持续和后果权衡，O 调节探究；人格不能生成候选或绕过合法性。</li><li>自愿行动先生成带来源的人格证据；至少跨 3 个月和 2 个情境后，月末才可能变化 1 点。滚动一年每维最多 2 点，累计偏移限于 ±20。</li><li>必须回应 / 履约先由门禁处理；小于 1 分的稳定种子值只破同分，不能制造动机。</li><li><b>可选模型重选</b>：只有设置页启用模型演进时，实时会话才把必须回应、生活对话、空闲新方向、停滞或复核等关键上下文的合法候选交给模型；本地演进直接采用完整规则决定。开局、危险和履约不等待模型；返回结果还要再次校验 option、follow-up 与结构化立场。</li></ul></article>
                        <ol>
              ...
              <li>
                ...
                <ol>
                  ...
                  <li><span class="edge-label edge-no">缺来源或方法</span>
                    <article class="logic-node" data-kind="condition"><span>C2-B</span><h4>本人有可用证据？</h4><ul><li>可见或有来源记忆的材料地点 → 生成路线 / 取材。</li><li>未知来源 → 只在有限可见范围内搜索。</li><li>未知方法 → 用眼前材料做预算受限的假说试验。</li></ul></article>
                    <ol>
                  ...
                  <li><span class="edge-label">已生成动作</span>
                    ...
                    <ol>
                      ...
                      <li><span class="edge-label edge-yes">是</span>
                        ...
                        <ol>
                          <li><span class="edge-label">动作后</span><article class="logic-node compact-node" data-kind="terminal"><span>RETURN</span><h4>更新项目并检查中断返回</h4><p>子意图完成 / 阻塞 / 不可用时，恢复父意图的精确上下文；月末再结算身体、人口、项目、共同体与只读观察器。</p></article></li>
                        </ol>
                      </li>
                    </ol>
                  </li>
    ...
    <section class="rules-section" id="authorityBoundary" aria-labelledby="authorityBoundaryTitle">
      ...
      <aside class="model-sidecar">
        ...
        <div><span>OPTIONAL MODEL SIDECAR</span><strong>模型可以重选少量合法方向、补充人物话语和叙事，但不能直接写入世界</strong><p>实时关键决定只接受当前候选 ID，并由领域层复核后创建意图；重大事实叙事仍是只读投影。无密钥、超时或非法结果均使用规则回退，后台快速演化不调用模型。</p></div>
      </aside>
    </section>
    ...
    <section class="rules-section source-section" id="ruleSources" aria-labelledby="ruleSourcesTitle">
      ...
      <div class="source-grid">
        <article><strong>月度主循环</strong><code>application/monthly-simulation.ts</code><span>15 tick、执行顺序、月初 / 月末结算</span></article>
        <article><strong>人物选项</strong><code>application/action-options.ts</code><span>局部感知与合法可供性候选</span></article>
        <article><strong>因子森林</strong><code>application/decision-factor-forest.ts</code><span>八棵可解释因果树、来源与同分裁决</span></article>
