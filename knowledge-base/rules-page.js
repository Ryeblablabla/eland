      ...
      <div class="rule-branch-grid">
        ...
        <details class="rule-branch" data-tone="social" open>
          ...
          <ul>
            ...
            <li><strong>度量功能假说</strong><span>缺少比较装置时，人物按当前可得实体的粗可感知性质，有限尝试“两件相同的适度刚性构件 + 柔性悬挂件”；已有装置后，再尝试“硬质稳定实体 + 柔性标记”的可重复参考物。候选只读固体 / 金属 / 纤维、粗硬度、粗质量和本人来源，不查询 BeamBalance / StandardWeight 隐藏配方；二 / 三份实体的精确数量进入试验，已经取得的仪器、参考物和已写载体保持受保护实体。</span></li>
