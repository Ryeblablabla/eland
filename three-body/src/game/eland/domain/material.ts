...
export const MATERIAL_PALETTE: readonly MaterialDefinition[] = [
  ...
  { id: Material.Wood, key: 'wood', name: '木材', phase: 'solid', tags: ['solid', 'fuel', 'building', 'tool-material', 'flammable'], hardness: 4, mass: 1, color: [91, 61, 38], perceptual: { form: 'structural-member' }, retainsWater: true },
  ...
  { id: Material.Plank, key: 'plank', name: '木板', phase: 'solid', tags: ['solid', 'building', 'fuel', 'flammable'], hardness: 4, mass: 0.7, color: [155, 111, 65], perceptual: { form: 'structural-member' }, retainsWater: true },
  ...
  { id: Material.Copper, key: 'copper', name: '铜', phase: 'solid', tags: ['solid', 'metal', 'tool-material'], hardness: 5, mass: 2.1, color: [181, 101, 55], retainsWater: true },
  ...
  { id: Material.Iron, key: 'iron', name: '锻铁', phase: 'solid', tags: ['solid', 'metal', 'building', 'tool-material'], hardness: 9, mass: 2.5, color: [93, 99, 101], retainsWater: true },
  ...
  { id: Material.FiredBrick, key: 'fired_brick', name: '烧结砖', phase: 'solid', tags: ['solid', 'building'], hardness: 6, mass: 1.4, color: [159, 78, 52], perceptual: { form: 'structural-member' }, retainsWater: true },
  ...
  { id: Material.Steel, key: 'steel', name: '钢', phase: 'solid', tags: ['solid', 'metal', 'building', 'tool-material'], hardness: 10, mass: 2.5, color: [111, 119, 123], retainsWater: true },
